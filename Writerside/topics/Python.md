...
```
## Data Structures
| Data Structure | syntax                                                           | Indexed              | Syntax                                                     | Ordered?                 | Mutability   | Allow Duplicates | Items                                                                                                                                             |
|----------------|------------------------------------------------------------------|----------------------|------------------------------------------------------------|--------------------------|--------------|------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|
| List           | `mylist = ["apple", "banana", "cherry"]`                         | Indexed              | Square brackets \[ \]                                      | Ordered                  | Changeable   | YES              |                                                                                                                                                   |
| Set            | `myset = {"apple", "banana", "cherry"}`                          | Un-indexed           | Curly brackets { }                                         | Unordered                | Changeable   | NO               | Item content in a set cannot be changed  <br>i.e. "apple" cannot be changed to "m_apple"  <br>but: "apple" item can be removed and "m_apple"added |
| Tuple          | `mytuple = ("apple", "banana", "cherry")`                        | Indexed              | Round Brackets ( )                                         | Ordered                  | Unchangeable | YES              |                                                                                                                                                   |
| Dictionary     | `thisdict = {"brand": "Ford", "model": "Mustang", "year": 1964}` | Indexed by the "key" | Curly brackets  <br>{ "key": "value",  <br>"key": "value"} | Ordered as of Python 3.7 | Changeable   | NO               |                                                                                                                                                   |